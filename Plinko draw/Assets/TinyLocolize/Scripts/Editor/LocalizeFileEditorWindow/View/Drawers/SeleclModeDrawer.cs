...
public class SeleclModeDrawer : IModeDrawer
{
    ...
    private Action autoTranslaterRunned;

    public SeleclModeDrawer(ILocalEditorPresenter presenter, Action<LocolizeNode> buttonPressed, Action backButtonPressed, Action autoTranslaterRunned)
    {
        _presenter = presenter;

        this.buttonPressed = buttonPressed;
        this.backButtonPressed = backButtonPressed;
        this.autoTranslaterRunned = autoTranslaterRunned;
    }
    ...
    public void Draw()
    {
        ...
        if (GUILayout.Button("Auto Translater"))
        {
            autoTranslaterRunned?.Invoke();
        }

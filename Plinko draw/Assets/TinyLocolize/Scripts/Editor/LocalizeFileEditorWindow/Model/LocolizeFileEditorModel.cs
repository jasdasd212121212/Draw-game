...
public class LocolizeFileEditorModel : ILocalEditorModel
{
    ...
    public LocolizeNode[] Nodes => _parser.GetDeserialized(_localLoader.LoadLocalSync()).Nodes;
    ...
    {
        return _parser.GetDeserialized(_localLoader.LoadLocalSync()).Nodes;
    }
    ...
    public LocolizeNode FindNodeOfName(string name)
    {
        LocolizeNode[] nodes = Nodes;
